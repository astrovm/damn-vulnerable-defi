...
contract NaiveReceiverChallenge is Test {
    ...
    function test_naiveReceiver() public checkSolvedByPlayer {
        // Build multicall data: 10 flash loans + 1 withdrawal
        bytes[] memory callDatas = new bytes[](11);

        // 10 flash loans to drain receiver's 10 WETH (1 WETH fee each)
        ...
        // Withdraw all 1010 WETH from pool as deployer
        // Append deployer address so _msgSender() returns deployer in the delegatecall
        ...
        // Build forwarder request targeting the pool
        ...
        // Sign the request with player's private key (EIP-712)
